...
extern bool hyundai_radar_icu;
bool hyundai_radar_icu = false;
...
void hyundai_common_init(uint16_t param) {
  ...
  hyundai_radar_icu = GET_FLAG(current_safety_param_sp, HYUNDAI_PARAM_SP_RADAR_ICU);
